...
public class Interpreter implements Visitor {
    ...
    public void visit(Instruction.InvokeInterface inst) {
        ...
        vmt.setExecuteEnv(objType, vmt.getMethod(objType, inst.type.getMethodSign()), inst.vargvs);
    }
    ...
    public void visit(Instruction.InvokeSuperRange inst) {
        vmt.saveThreadState();
        String superType = ((Instance)vmt.currentFrame.reg[inst.vargvs[0]]).getSuperClazz();
        vmt.setExecuteEnv(superType, vmt.getMethod(superType, inst.type.getMethodSign()), inst.vargvs);
    }
    ...
    public void visit(Instruction.InvokeDirectRange inst) {
        ...
        vmt.setExecuteEnv(clazzName, vmt.getMethod(clazzName, inst.type.getMethodSign()), inst.vargvs);
    }
