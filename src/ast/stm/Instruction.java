...
{ /* This is just a opspace. YKG */
  ...
  public static class ArrayDataDirective extends T
  {
    ...
    public ArrayDataDirective(String width, List<String> elementList)
    {
      ...
      // this.size = elementList.size() / vm.Util.hex2int(width);
      this.size = (int)(elementList.size() / Long.parseLong(width, 16));
    }
    ...
    private Object getArrayElementByIndex(int index)
    {
      ...
      for (int i = 0; i < Integer.parseInt(width); i++) {
        //e = vm.Util.hex2long(elementList.get(index + i));
        e = Long.parseLong(elementList.get(index + i), 16);
        value |= e << (i * 8);
      }
      return value;
    }
