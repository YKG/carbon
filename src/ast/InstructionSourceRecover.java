 ...
 * */
public class InstructionSourceRecover extends VisitorAdapter {
...
//		}
	...
	public void visit(ast.classs.Class clazz) {
		...
		// annotations
		for (Annotation annotation : clazz.annotationList)
		...
		for (ast.classs.Class.Field field : clazz.fieldList) {
			...
			if (field.annotationList != null) {
				for (Annotation annotation : field.annotationList) {
					annotation.accept(this);
				}
...
//		}
	...
	public void visit(ast.method.Method method) {
		...
		for (ast.method.Method.Parameter parameter : method.parameterList) {
			...
			// annotations
			for (Annotation annotation : parameter.annotationList) {
				annotation.accept(this);
			}
			if (endParameter) {
				this.printSpace();
		...
		if (method.annotationList != null)
			for (Annotation annotation : method.annotationList) {
				annotation.accept(this);
			}
		this.sayln("");
				...
				if (labelIndex < method.labelList.size()
						&& (currentLab.lab.startsWith("sswitch_data")
								|| currentLab.lab.startsWith("pswitch_data") || currentLab.lab
									.startsWith("array_"))
						&& (stm instanceof Instruction.PackedSwitchDirective
								|| stm instanceof Instruction.SparseSwitchDirective || stm instanceof Instruction.ArrayDataDirective)) {
					this.printSpace();
	...
	public void visit(SubAnnotation subAnnotation) {
		...
		this.indent();
		for (Annotation.AnnotationElement element : subAnnotation.elementList) {
			this.printSpace();
	...
	public void visit(ElementLiteral elementLiteral) {
		...
		if (elementLiteral.type.equals("subannotation")) {
			...
			((SubAnnotation) elementLiteral.element
					.get(0)).accept(this);
			this.printSpace();
    ...
    public void visit(Instruction.Move inst) {
        this.position += instLen.get(inst.op);
        inst.source += inst.op + " " + inst.dest + ", " + inst.src;
    }
    ...
    public void visit(Instruction.Const4 inst) {
        ...
        inst.source += inst.op + " " + inst.dest + ", " + inst.value;
    }
    ...
    public void visit(Instruction.ConstString inst) {
        ...
        inst.source += inst.op + " " + inst.dest + ", " + inst.str;
    }
    ...
    public void visit(Instruction.CheckCast inst) {
        this.position += instLen.get(inst.op);
        inst.source += inst.op + " " + inst.ref + ", " + inst.type;
    }

    // 20 22c instance-of vA, vB, type@CCCC
    public void visit(Instruction.InstanceOf inst) {
        this.position += instLen.get(inst.op);
        inst.source += inst.op + " " + inst.dest + ", " + inst.ref + ", " + inst.type;
    }
    ...
    public void visit(Instruction.NewArray inst) {
        this.position += instLen.get(inst.op);
        inst.source += inst.op + " " + inst.dest + ", " + inst.size + ", " + inst.type;
    }
    ...
    public void visit(Instruction.FilledNewArrayRange inst) {
        ...
        inst.source += inst.op;
        inst.source += " {";
        inst.source += inst.start + " .. " + inst.end;
        inst.source += "}, ";
        inst.source += inst.type;
    }
    ...
    public void visit(Instruction.PackedSwitch inst) {
        this.position += instLen.get(inst.op);
        inst.source += inst.op + " " + inst.test + ", :" + inst.offset;
    ...
    public void visit(Instruction.CmplFloat inst) {
        this.position += instLen.get(inst.op);
        inst.source += inst.op + " " + inst.dest + ", " + inst.first + ", " + inst.second;
    ...
    public void visit(Instruction.IfEq inst) {
        this.position += instLen.get(inst.op);
        inst.source += inst.op + " " + inst.first + ", " + inst.second + ", :" + inst.dest;
    ...
    public void visit(Instruction.IfEqz inst) {
        this.position += instLen.get(inst.op);
        inst.source += inst.op + " " + inst.test + ", :" + inst.dest;
    }
    ...
    public void visit(Instruction.Aget inst) {
        this.position += instLen.get(inst.op);
        inst.source += inst.op + " " + inst.dest + ", " + inst.array + ", " + inst.index;
    ...
    public void visit(Instruction.Aput inst) {
        this.position += instLen.get(inst.op);
        inst.source += inst.op + " " + inst.src + ", " + inst.array + ", " + inst.index;
    ...
    public void visit(Instruction.Iget inst) {
        this.position += instLen.get(inst.op);
        inst.source += inst.op + " " + inst.dest + ", " + inst.field + ", " + inst.type.toString();
    ...
    public void visit(Instruction.Iput inst) {
        this.position += instLen.get(inst.op);
        inst.source += inst.op + " " + inst.src + ", " + inst.field + ", " + inst.type.toString();
    ...
    public void visit(Instruction.Sget inst) {
        this.position += instLen.get(inst.op);
        inst.source += inst.op + " " + inst.dest + ", " + inst.type.toString();
    }
    ...
    public void visit(Instruction.Sput inst) {
        this.position += instLen.get(inst.op);
        inst.source += inst.op + " " + inst.src + ", " + inst.type.toString();
    }
    ...
    public void visit(Instruction.InvokeVirtual inst) {
        ...
        inst.source += "}, ";
        inst.source += inst.type.toString();
    }
    ...
    public void visit(Instruction.AddIntLit16 inst) {
        ...
        if (inst.value.startsWith("\'"))
            inst.value = this.processChar(inst.value);
        inst.source += inst.op + " " + inst.dest + ", " + inst.src + ", " + inst.value;
    ...
    @Override
    public void visit(Instruction.ArrayDataDirective inst) {
        inst.source += ".array-data " + inst.width;
        this.indent();
        this.printSpace();
        int cnt = 0;
        ...
        this.unIndent();
        this.printSpace();
        inst.source += ".end array-data";
    }

    @Override
    public void visit(Instruction.PackedSwitchDirective inst) {
        if (inst.key.startsWith("\'"))
            inst.key = this.processChar(inst.key);
        inst.source += ".packed-switch " + inst.key;
        this.indent();
        ...
        this.unIndent();
        this.printSpace();
        inst.source += ".end packed-switch";
    }

    @Override
    public void visit(Instruction.SparseSwitchDirective inst) {
        String str;
        inst.source += ".sparse-switch ";
        this.indent();
        for (int i = 0; i < inst.labList.size(); i++) {
            ...
            if (str.startsWith("\'"))
                str = this.processChar(str);
            inst.source += str + " -> :" + inst.labList.get(i);
        }
        this.unIndent();
        this.printSpace();
        inst.source += ".end sparse-switch";
    }

	public InstructionSourceRecover() {
		this.filePath = null;
